...
namespace Terraria.Audio
{
  public class LegacySoundStyle : SoundStyle
  {
    ...
    public int Style
    {
      get
      {
        return this._styleVariations != 1 ? LegacySoundStyle._random.Next(this._style, this._style + this._styleVariations) : this._style;
      }
    }
    ...
    {
      return this.IsTrackable ? Main.trackableSounds[this.Style] : (SoundEffect) null;
    }
  }
}
